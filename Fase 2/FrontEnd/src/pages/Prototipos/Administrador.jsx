        ...
        <div className="form-signin1">
          <div className="text-center">
            <form className="card card-body">
              <h1 className="h3 mb-3 fw-normal">MENÚ ADMINISTRADOR</h1>
              <br />
              <br />
              ...
              <div className="d-flex justify-content-between">
                <button className="btn btn-outline-primary" onClick={reportes}>
                  Tabla de Alumnos
                </button>
                <button className="btn btn-outline-success" onClick={reportes}>
                  Reportes
                </button>
                <button className="btn btn-outline-success" onClick={salir}>
                  Salir
                </button>
              </div>
              <br />
