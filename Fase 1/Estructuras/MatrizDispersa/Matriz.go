...
func (m *Matriz) Insertar_Elemento(carnet_estudiante int, carnet_tutor int, curso string) {
	...
	if nodoColumna == nil && nodoFila == nil {
		...
		m.Cantidad_Alumnos++
		m.Cantidad_Tutores++
		m.insertarColumna(&NodoMatriz{PosX: nodoColumna.PosX, PosY: nodoFila.PosY, Dato: &Dato{Carnet_Tutor: carnet_tutor, Carnet_Estudiante: carnet_estudiante, Curso: curso}}, nodoFila)
		m.insertarFila(&NodoMatriz{PosX: nodoColumna.PosX, PosY: nodoFila.PosY, Dato: &Dato{Carnet_Tutor: carnet_tutor, Carnet_Estudiante: carnet_estudiante, Curso: curso}}, nodoColumna)
